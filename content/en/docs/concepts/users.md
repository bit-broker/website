...
In practice, users assume a role by being in receipt of an [authorization token](/docs/api-conventions/authorization/), which grants them the ability to perform actions using the corresponding API.
