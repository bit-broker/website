...
Regardless of the type of installation you are using, you should be aware of the ways in which fresh installations perform certain bootstrap operations.
...
Since authorisation is _only_ applied in Kubernetes installs, the bootstrap user is only of significance there. If you are installing using [Docker Compose](#docker-compose-local-installation) or on your [bare machine](#direct-installation-on-a-physical-machine), it is not a vital concept.
...
The Kubernetes install steps below, will contain more information about how to extract and use this bootstrap token.
